...
class ActividadesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('components.modal_actividades',['actividades'=> $actividades]);
        ...
        $rules= array (
           ...
           if($validador->fails()){
            ...
            return \Redirect::back()->withInput()->withErrors($validador);
                ...
                $actividades->nombre=$datos["nombre"];
                $actividades->precio=$datos["precio"];
                $actividades->descripcion=$datos["descripcion"];
                $actividades->tipo=$datos["tipo"];
