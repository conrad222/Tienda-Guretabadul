...
= 1.2.3 =
* Remove admin dismiss notice

= 1.2.2 =
* Remove css map error
* Recommed few woocomerce plugins

= 1.2.1 =
* Add Icon action hook

= 1.2.0 =
* Add Class variable
* fixed current_page_item active issue.
