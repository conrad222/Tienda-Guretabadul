...
<p class="parrafoigualdad" style="color:#8024A0; font-size:30px;  font-family: 'Eminenz', arial; text-shadow: 4px 4px 4px #aaa;" ><?php echo trans('jokes.IGUALDAD'); ?></p>

<div class="img-arbol">
<img src="./img/arbolito.png" width="800px" height="800px" />
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.masterpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Iker\Desktop\UniServerZ\www\Tienda-Guretabadul\practica_laravel\resources\views/secciones/inicio.blade.php ENDPATH**/ ?>