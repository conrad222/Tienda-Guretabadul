...
class MatchAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('components.modal_admin_usermatch',['users'=> $users]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $rules= array (
           ...
           $messages= array (
            ...
            'idioma.required' => 'Campo idioma es requerido',
            'oferta.required' => 'Campo oferta es requerido',
            'demanda.required' => 'Campo demanda es requerido',
           );
           ...
           if($validador->fails()){
            ...
            return \Redirect::back()->withInput()->withErrors($validador);
                ...
                $users->idioma=$datos["idioma"];
                $users->oferta=$datos["oferta"];
                $users->demanda=$datos["demanda"];
