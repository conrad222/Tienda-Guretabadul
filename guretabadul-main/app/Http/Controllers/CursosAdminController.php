...
class CursosAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $cursosAdmin = Cursos::all();
        return view('components.modal_admin_cursos',['cursosAdmin'=> $cursosAdmin]);
    }
        ...
        $rules= array (
           ...
           if($validador->fails()){
            ...
            return \Redirect::back()->withInput()->withErrors($validador);
                 ...
                 //Generar actividad
                $cursoAdmin=new Cursos();
                $cursoAdmin->tipo=$datos["tipo"];
                $cursoAdmin->nombre=$datos["nombre"];
                $cursoAdmin->precio=$datos["precio"];
                $cursoAdmin->descripcion=$datos["descripcion"];
                $cursoAdmin->fecha=$datos["fecha"];
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Cursos $cursosAdmin)
    {
        $cursosAdmin->delete();
