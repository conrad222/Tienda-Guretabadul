...
<head>
    ...
    <title> @yield('titulo') | KALPATARU </title>
    <!-- CSS only -->
  ...
  <div class="container-f">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0" >
        ...
        @if(auth()->check())
        <li class="nav-item">
          <a class="nav-link active"> {!! trans('jokes.Bienvenida') !!} <b>{{auth()->user()->name}}</b></a>
          <li class="nav-item">
            <a class="nav-link active" id="logout" onMouseOver="this.style.cssText='color: #cc0000'" onMouseOut="this.style.cssText='color: #fff'"  aria-current="page" href="{{ route('login.destroy') }}">{!! trans('jokes.Cerrar Sesión') !!}</a></a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="{{ route('secciones.inicio') }}" style="color:white;">{!! trans('jokes.Inicio') !!}</a></a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="{{ route('mensajes.index') }}" style="color:white;">{!! trans('jokes.Mensajes') !!}</a></a>
            </li>
            ...
            <ul class="dropdown-menu"  >
              <li class="nav-item" ><a class="dropdown-item" type="button" href="{{route('userAdmin.index')}}">{!! trans('jokes.Administrar web') !!}</a></li>
              <li class="nav-item" ><a class="dropdown-item" type="button" href="{{route('mensajesadmin.index')}}">{!! trans('jokes.Administrar mensajes') !!}</a></li>
            </ul>
          </div>
          <li class="nav-item">
            @if (config('locale.status') && count(config('locale.languages')) > 0)
                    @foreach (array_keys(config('locale.languages')) as $lang)
                        @if ($lang != App::getLocale())
                            <a  class="nav-link " href="{!! route('lang.swap', $lang) !!}" style="padding-right:0px; margin-right:0px; color:white;">
                                    {!! $lang !!}/
                            </a>
            </li>
                        @endif
            ...
            @if (config('locale.status') && count(config('locale.languages')) > 0)
                    @foreach (array_keys(config('locale.languages')) as $lang)
                        @if ($lang == App::getLocale())
                            <a  class="nav-link" href="{!! route('lang.swap', $lang) !!}" style="padding-left:0px; margin-left:0px; color:white;">
                                    <strong>{!! $lang !!}</strong>
                            </a>
                        @endif
                    @endforeach
          ...
          @endif
            ...
            @else
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="{{ route('login.index') }}" style="color:white;">{!! trans('jokes.Iniciar Sesion') !!}</a></a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="{{ route('register.index') }}" style="color:white;">{!! trans('jokes.Registrarse') !!}</a></a>
                </li>
