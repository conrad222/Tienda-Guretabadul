...
@if (Auth::user()->role_id=="1")
                ...
                <li class="nav-item">
            <a class="nav-link active" id="admin" onMouseOver="this.style.cssText='color: #cc0000'" onMouseOut="this.style.cssText='color: #fff'"  aria-current="page" href="{{ route('voyager.dashboard') }}">Administradora</a></a>
            </li>
            @endif
            <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{route('cursos.index')}}" >Cursos</a>
