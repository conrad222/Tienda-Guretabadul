...
<head>
    ...
    <title> <?php echo $__env->yieldContent('titulo'); ?> | KALPATARU </title>
    <!-- CSS only -->
  ...
  <div class="container-f">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0" >
        ...
        <?php if(auth()->check()): ?>
        <li class="nav-item">
          <a class="nav-link active"> <?php echo trans('jokes.Bienvenida'); ?> <b><?php echo e(auth()->user()->name); ?></b></a>
          <li class="nav-item">
            <a class="nav-link active" id="logout" onMouseOver="this.style.cssText='color: #cc0000'" onMouseOut="this.style.cssText='color: #fff'"  aria-current="page" href="<?php echo e(route('login.destroy')); ?>"><?php echo trans('jokes.Cerrar Sesión'); ?></a></a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="<?php echo e(route('secciones.inicio')); ?>" style="color:white;"><?php echo trans('jokes.Inicio'); ?></a></a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="<?php echo e(route('mensajes.index')); ?>" style="color:white;"><?php echo trans('jokes.Mensajes'); ?></a></a>
            </li>
            <?php if($usuario->role_id=="1"): ?>
            <div class="dropdown">
               <a class="btn nav-link  me-3 dropdown-toggle" type="button" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false">
              ADMIN
            </a>
            <ul class="dropdown-menu"  >
              <li class="nav-item" ><a class="dropdown-item" type="button" href="<?php echo e(route('userAdmin.index')); ?>"><?php echo trans('jokes.Administrar web'); ?></a></li>
              <li class="nav-item" ><a class="dropdown-item" type="button" href="<?php echo e(route('mensajesadmin.index')); ?>"><?php echo trans('jokes.Administrar mensajes'); ?></a></li>
            </ul>
          </div>
          <li class="nav-item">
            <?php if(config('locale.status') && count(config('locale.languages')) > 0): ?>
                    <?php $__currentLoopData = array_keys(config('locale.languages')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($lang != App::getLocale()): ?>
                            <a  class="nav-link " href="<?php echo route('lang.swap', $lang); ?>" style="padding-right:0px; margin-right:0px; color:white;">
                                    <?php echo $lang; ?>/
                            </a>
            </li>
                        <?php endif; ?>
            ...
            <?php if(config('locale.status') && count(config('locale.languages')) > 0): ?>
                    <?php $__currentLoopData = array_keys(config('locale.languages')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($lang == App::getLocale()): ?>
                            <a  class="nav-link" href="<?php echo route('lang.swap', $lang); ?>" style="padding-left:0px; margin-left:0px; color:white;">
          ...
          <?php endif; ?>
            ...
            <?php else: ?>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="<?php echo e(route('login.index')); ?>" style="color:white;"><?php echo trans('jokes.Iniciar Sesion'); ?></a></a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="<?php echo e(route('register.index')); ?>" style="color:white;"><?php echo trans('jokes.Registrarse'); ?></a></a>
                </li>
...
<div id="contenido" class="col-10 mx-auto pt-1">
...
var untidy=1; // how often do you want the leaves tidied up (high number is less often)
...
<?php /**PATH C:\Users\Iker\Desktop\UniServerZ\www\Tienda-Guretabadul\practica_laravel\resources\views/layout/masterpage.blade.php ENDPATH**/ ?>