...
<div class="servicios">
    ...
    <div class="flexbox-container">
        <div class="servicio1"><label><img class="corazon" src="<?php echo e(url('img/amor.png')); ?>"></label><h4>Cultivar actitudes interculturales positivas.</h4></div>
        <div class="servicio2"><label><img class="libro" src="<?php echo e(url('img/libro.png')); ?>"></label><h4>Mejorar el autoconcepto personal, cultural y académico.</h4></div>
    </div>
    <div class="flexbox-container">
        <div class="servicio3"><label><img class="igualdad" src="<?php echo e(url('img/tomados-de-la-mano.png')); ?>"></label><h4>Fomentar la igualdad y el respeto mutuo.</h4></div>
        <div class="servicio4"><label><img class="unidad" src="<?php echo e(url('img/unidad.png')); ?>"></label><h4>Potenciar la convivencia entre mujeres de diferentes culturas.</h4></div>
    </div>
    </div>
</div>
<div class="nosotros">
...
<?php echo $__env->make('layout.masterpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\UniServerZ\UniServerZ2\www\GureTabadul\Laravel\resources\views/secciones/inicio.blade.php ENDPATH**/ ?>