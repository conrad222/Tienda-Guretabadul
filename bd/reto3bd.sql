...
CREATE DATABASE IF NOT EXISTS `reto3bd` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `reto3bd`;
...
-- Volcando datos para la tabla reto3bd.cursos: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla reto3bd.intercambios: ~1 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `productos` (
  ...
  `nombreP` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `precio` double NOT NULL,
...
-- Volcando datos para la tabla reto3bd.productos: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla reto3bd.tienda: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla reto3bd.users: ~3 rows (aproximadamente)
